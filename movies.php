            ...
            <li class="nav-item">
               ...
               <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                  <div class="bg-white py-2 collapse-inner rounded">
                     ...
                     <a class="collapse-item" href="movies.html">Utilisateurs</a>
                     <a class="collapse-item" href="movies-detail.html">Acteurs</a>
                     <a class="collapse-item" href="events.html">Evenements</a>
                           ...
                           <div class="col-xl-4 col-md-6 mb-4">
                              <div class="card m-card shadow border-0">
                                 <a href="movies-detail.html">
                                    ...
                                    <div class="card-body p-3">
                                       <h5 class="card-title text-gray-900 mb-1"><?php echo $item['titre']; ?></h5>
                                       <p class="card-text"><small class="text-muted"><?php echo $item['pays']; ?></small> <small class="text-danger"><i class="fas fa-calendar-alt fa-sm text-gray-400"></i><?php echo $item['date_sortie']; ?></small> </p>
                                    </div>
                                 </a>
                              </div>
                           </div>
