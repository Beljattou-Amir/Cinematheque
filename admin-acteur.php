                    ...
                    <!-- class="h5 mb-0 text-gray-900" -->
                        ...
                        <table border="1">
                           ...
                           <tr>
                              ...
                              <td><?php echo $item['nomA']; ?></td>
                              <td><?php echo $item['prenomA']; ?></td>
                              <td><?php echo $item['nationalite']; ?></td>
                              <td><?php echo $item['date_naissance']; ?></td>
                              <td><?php echo $item['role']; ?></td>
                              <td><?php echo $item['prix']; ?></td>
                              <td><?php echo $item['biographie']; ?></td>
                           ...
                           <form action="adminadda.php" method="post" method="post">
                           ...
                           <input required type="text" name="prix" value=" ">
                           <input required type="text" name="biographie" value=" ">
                           <button type="submit" name="button">Ajouter</button>
                           
                            </form>
                            <form method="post" action="suppa.php">
                            <select name="test">
                            <?php
                           ...
                           ?>
                                <option value="<?php echo $item['nomA']; ?>"><?php echo $item['nomA']; ?></option>
                           ...
                           ?>
                            ...
                            <form action="admina.php" method="post" method="post">
                           <input required type="text" name="nom" value=" ">
                           <input required type="text" name="prenom" value=" ">
                           <input required type="text" name="email" value=" ">
                           <input required type="date" name="date_naiss" value=" ">
