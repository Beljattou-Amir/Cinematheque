                    ...
                    <!-- class="h5 mb-0 text-gray-900" -->
                        ...
                        <table border="1">
                           ...
                           <tr>
                              ...
                              <td><?php echo $item['date_sortie']; ?></td>
                              <td><?php echo $item['synopsis']; ?></td>
                              <td><?php echo $item['type']; ?></td>
                              <td><?php echo $item['critique']; ?></td>
                           ...
                           <form class="form-horizontal" method="post" action="adminaddf.php" enctype="multipart/form-data">
                           ...
                           <input required type="text" name="type" value=" ">
                           <input required type="text" name="critique" value=" ">
						  ...
						  <input id="file" name="file" type="file" placeholder="" class="form-control input-md">
                           ...
                           <button id="create" name="create" class="btn btn-primary">Ajouter</button>
                            ...
                            <form method="post" action="suppf.php">
                            <select name="test">
                            <?php
                           ...
                           ?>
                                <option value="<?php echo $item['titre']; ?>"><?php echo $item['titre']; ?></option>
                           ...
                           ?>
                            ...
                            <form action="adminf.php" method="post" method="post">
                            <input required type="text" name="nom" value=" ">
                           <input required type="text" name="prenom" value=" ">
                           <input required type="text" name="email" value=" ">
                           <input required type="date" name="date_naiss" value=" ">
