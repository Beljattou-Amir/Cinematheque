...
<html lang="en">
   <head>
      ...
      <link rel="stylesheet" href="https://www.w3schools.com/w3css/4/w3.css%22%3EW">
   </head>
   <body id="page-top">
                  ...
                  <!-- class="d-sm-flex align-items-center justify-content-between mt-4 mb-3"> -->
                    ...
                    <!-- class="h5 mb-0 text-gray-900" -->
                        ...
                        <table border="1">
                           ...
                           <form class="form-horizontal" method="post" action="test3.php" enctype="multipart/form-data">
                           <input required type="text" name="nom" value=" ">
                           <input required type="date" name="prenom" value=" ">
                           <input required type="date" name="email" value=" ">
                           <input required type="text" name="date_naiss" value=" ">
						  ...
						  <input id="file" name="file" type="file" placeholder="" class="form-control input-md">
                           ...
                           <button id="create" name="create" class="btn btn-primary">Ajouter</button>
                            ...
                            <form method="post" action="suppe.php">
                            <select name="test">
                            <?php
                           ...
                           ?>
                            ...
                            <form action="admine.php" method="post" method="post">
                           <input required type="text" name="nom" value=" ">
                           <input required type="date" name="prenom" value=" ">
                           <input required type="date" name="email" value=" ">
                           <input required type="text" name="date_naiss" value=" ">
