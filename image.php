		...
		<div class="text-center">
			<?php 
				...
				if(isset($_POST['create'])) {
					$data 		= [
						'titre' 		=> $_POST['title'],
						'pays' 	=> $_POST['description'],
						'type' 		=> $_POST['author'],
						'date_sortie' 	=> new MongoDB\BSON\UTCDateTime
					];
		    	...
		    	<?php 
		    		...
		    		foreach ($articles as $key => $article) {
		    			...
		    			echo '<div class="rows">
								...
								<div class="rows">
									<div class="col-md-3"><img src="img/'.$article['fileName'].'" width="180"></div>
									<div class="col-md-8">
										<strong>'.$article['titre'].'</strong>
										<p>'.$article['pays'].'</p>
										<p class="text-right">'.$article['type'].'</p>
									</div>';
